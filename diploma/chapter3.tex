...
\section{Pojęcie systemu informatycznego}	
	...
	\subsection{Rodzaje systemów informatycznych w logistyce}
		\begin{center}
			\begin{longtable}[c]{| l | l | l |}
					...
					\hline
						...
						\multicolumn{1}{|c|}{\textbf{Nazwa polska}}	\tabularnewline
					\hline
					\endfirsthead
					...
					\hline
						\multicolumn{3}{|r|}{{Następna strona...}} \tabularnewline \hline
					\endfoot
		...
		\begin{center}
			\begin{longtable}{| p{0.5cm} | p{1.7cm} | p{13cm} |}
					...
					\hline
						...
						\multicolumn{1}{|c|}{\textbf{Funkcja}}	\tabularnewline
					\hline
					\endfirsthead
					...
					strategicznych \cite{fk_system}. 	\tabularnewline
					\hline
					...
					wielu modeli w jedną całość. 		\tabularnewline
					\hline
					...
					wykonywanych przez człowieka \cite{erp_system}.\tabularnewline
					\hline	
					...
					adaptacyjne do zmieniających się warunków na rynku \cite{scm_system}.\tabularnewline
					\hline
			\end{longtable}
		\end{center}

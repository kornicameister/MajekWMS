...
\section{Rola magazynu w łańcuchu dostaw}
	...
	\subsection{Magazynowania jako proces magazynowania}
		...
		równowa\-żna z wprowadzaniem danych o przyjmowanych dobrach do magazynu i uaktualnieniu stanów. 
		Zanim to nastąpi należy rozładować produkty oraz poddać je kontroli zarówno jakościowej i ilościowej.
			...
			zgodnie ze sta\-nem np. dokumentu przewozowego. 
	...
	\subsection{Podział magazynu na strefy - cele i korzyści}
		...
		Ponieważ prócz operacji składowania muszą one zapewnić jednocześnie możliwość wydań i przyjęć tym bardziej odpowiednie,
